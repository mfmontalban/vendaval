...
import { verifyForgot, resendForgot, resetPassword } from '../../actions/authActions';
...
class Reset extends Component {
  ...
  componentDidMount() {
    ...
    if (this.props.match.params.key) {
      this.props.verifyForgot(this.props.match.params.key);
    }
  }
  ...
  onSubmitResend = (e) => {
    ...
    this.props.resendForgot(userData, this.props.history);
  }
  ...
  onSubmitReset = (e) => {
    ...
    this.props.resetPassword(this.props.match.params.key, userData, this.props.history);
  }
...
Reset.propTypes = {
  verifyForgot: PropTypes.func.isRequired,
  resendForgot: PropTypes.func.isRequired,
...
export default connect(mapStateToProps, { verifyForgot, resendForgot, resetPassword })(withRouter(Reset));
