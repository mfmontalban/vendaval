  ...
  render(){
    ...
    return(
      <div ref={this.setWrapperRef} className="mt-neg43px">
        ...
        {listOpen && 
          <Dropdown ref={this.setWrapperRef} className="ml-neg175px m-10px position-absolute z-1005 d-flex flex-direction-row text-left outer-shadow border-1" transitionStyled={`${application.transitions.general}`} backgroundStyled={`${application.mode.primary}`} colorStyled={`${application.theme.primary}`} radiusStyled={`${application.settings.appRadius}`}>
