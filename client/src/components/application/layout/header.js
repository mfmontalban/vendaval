    ...
    return (
      <div className="h-105px top-nav-margin">
        ...
        {/* <nav className="navbar navbar-expand navbar-dark bg-silvero fixed-top-2nd header-nav-shadow top-radius-rounded d-none d-xl-flex d-lg-flex d-md-flex flex-row flex-row justify-content-between">
          <Link className="mr-0 btn btn-outline-info" to={`/${winds}`}>Vendaval</Link>
          <div className="navbar-collapse" id="navbarNav">
            <ul className="navbar-nav">
              <li className="nav-item">
                <Link className="nav-link ml-3 text-info" to={`/${think}`}>
                  <FormattedMessage
                    id="navigation.think"
                    defaultMessage="Think"
                  />
              ...
              <li className="nav-item">
                <Link className="nav-link ml-3 text-info" to={`/${unite}`}>
                  <FormattedMessage
                    id="navigation.unite"
                    defaultMessage="Unite"
                  />
              ...
              <li className="nav-item">
                <Link className="nav-link ml-3 text-info" to={`/${create}`}>
                  <FormattedMessage
                    id="navigation.create"
                    defaultMessage="Create"
                  />
              ...
              <li className="nav-item">
                <Link className="nav-link ml-3 text-info" to={`/${experience}`}>
                  <FormattedMessage
                    id="navigation.experience"
                    defaultMessage="Experience"
                  />
